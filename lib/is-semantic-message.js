...
function checkCommit(commit) {
  ...
  console.log("333", { error, value: header })
  ...
  if (!isValid) {
    ...
    console.log('pppp', Object.assign({ body: null, footer: null }, commit, { header }))
...
function validateHeader(header) {
 ...
 console.log("jjjj", header, Object.assign({ scope: null }, header))
